// src/screens/MainScreenContent.js
import React, { useState, useEffect } from 'react';
import { 
  View, Text, FlatList, TouchableOpacity, StyleSheet, 
  TextInput, ScrollView, Image, Button, StatusBar, 
  SafeAreaView, Modal 
} from 'react-native';
import Ionicons from '@expo/vector-icons/Ionicons'; 
import { useRouter } from 'expo-router';

// Sesuaikan path import karena file pindah ke src/screens/
import TopUpScreen from './TopUpScreen'; 
import { getProducts, updateBalance, createOrder, getOrders } from '../services/api';
